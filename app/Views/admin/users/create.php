        ...
        <div class="card-body">
            ...
            <form action="<?= url('/admin/users') ?>" method="POST" class="space-y-4">
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="name" value="<?= e($old['name'] ?? '') ?>" class="input input-bordered <?= isset($errors['name']) ? 'input-error' : '' ?>" placeholder="Full Name">
                ...
                <div class="form-control w-full">
                    ...
                    <input type="email" name="email" value="<?= e($old['email'] ?? '') ?>" class="input input-bordered <?= isset($errors['email']) ? 'input-error' : '' ?>" placeholder="user@example.com">
                ...
                <div class="form-control w-full">
                    ...
                    <input type="password" name="password" class="input input-bordered <?= isset($errors['password']) ? 'input-error' : '' ?>" placeholder="Min 8 characters">
                ...
                <div id="unit-control" class="form-control w-full <?= ($old['role'] ?? '') === 'admin' ? 'hidden' : '' ?>">
                    ...
                    <select name="unit" class="select select-bordered <?= isset($errors['unit']) ? 'select-error' : '' ?>">
                        ...
                        <?php foreach($units as $u): ?>
                            <option value="<?= e($u['name']) ?>" <?= ($old['unit'] ?? '') === $u['name'] ? 'selected' : '' ?>><?= e($u['name']) ?></option>
                        <?php endforeach; ?>
                    </select>
